...
<div class="h-screen fixed left-0 top-0 z-30 transition-all duration-300 ease-in-out flex flex-col bg-white border-r border-gray-200"
  ...
  <button
    ...
    class="absolute -right-3 top-16 bg-white border border-gray-200 rounded-full p-1.5 hover:bg-gray-100 transition-colors duration-200"
  ...
  <div class="flex-1 overflow-y-auto py-4">
    ...
    <nav class="space-y-1 px-2">
      ...
      <NavLink
        href="/admin/kelas"
        icon="<svg xmlns='http://www.w3.org/2000/svg' class='h-5 w-5' fill='none' viewBox='0 0 24 24' stroke='currentColor'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M4 6a2 2 0 012-2h12a2 2 0 012 2v7a2 2 0 01-2 2H6a2 2 0 01-2-2V6z'/><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M3 10h18M10 14h4'/></svg>"
        label="Kelas"
        {isCollapsed}
        allowedRoles={['admin']}
      />
